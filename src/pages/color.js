...
const Color = () => (
  <div className="ds-app-grid">
    ...
    <div className="ds-main-content">
      <div className="ds-container">
        <h1>Colors</h1>
        <h3 className="subheading">The skill of coloring interfaces is being able to modify one base color into many different variations.</h3>
        ...
        <p className="ds-subheading-text-style">All UI elements make use of a sass function; <code>ds-color($variable, $range)</code> where <code>$varible</code> is the type of color and the <code>$range</code> is the number in the scale which determines how light or dark that color will be. This ensures consistency as it prevents hard coding #HEX values when creating or updating UI elements or pages.</p>
  ...
  height:     ds-space(super-loose);
        ...
        <SectionCodePen>
          <h4>Playground</h4>
          <p className="ds-subheading-text-style">Feel free to play around with the utility funtions. Just scroll all the way to the bottom of the SCSS file and create some shapes using the functions.</p>
