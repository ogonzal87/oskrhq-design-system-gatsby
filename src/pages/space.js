  ...
  <div className="ds-app-grid">
    ...
    <div className="ds-main-content">
      <div className="ds-container">
        ...
        <h3 className="subheading">Using a geometric progression scale to create consistency and rhythm in space.</h3> 
        ...
        <div className="ds-col-container">
          ...
          <div className="ds-col-6">
            <p className="ds-subheading-text-style">Digital Screens are made of a grid of teeny-tiny pixels. Kinda like a <a href="https://youtu.be/UdWCUr1FDqU?t=51s" target="_blank">microscopic net</a>. Following this mental model, I use a combination of a Soft and Hard 8-Point-Grid System. This means that space uses multiples of 8px to define dimensions, padding, and margin of both block and inline elements. This ensures all measures follow the same spacing rules and avoids many headaches when designers are discussing space with developers.</p>
          </div>

          <div className="ds-col-6">
            <p className="ds-subheading-text-style"><strong>Why 8px?</strong> Regardless of form-factor, most popular screen sizes are divisible by 8 on at least one axis - usually both. See <a href="https://builttoadapt.io/intro-to-the-8-point-grid-system-d2573cde8632" target="_blank">this article</a> to learn more.</p>

            <p className="ds-color-page-body ds-subheading-text-style" >The system has a predictable scale to measure fixed space - 4px (extra-tight), 8px (tight), 16px (base), 24px (bit-loose), 32px (loose), 48px (extra-loose), 64px (super-loose).</p>
          </div>
        ...
        <div className="ds-space-space-specimens-container">
          ...
          <div className="ds-space-space-specimen">
            ...
            <code>ds-space(super-loose)</code>
          </div>
        </div>
        ...
        <SectionCopy>
          ...
          <p className="ds-subheading-text-style">For containers or elements that need to be fluid, as in they need to expand a certain percentage of a parent container, the system uses a 12-column and 40px Gutter system along the x-axis with scss utility classes for its use. <strong>Just make sure you wrap the column elements with a div and assign it this css class: <code>.ds-col-container</code></strong>.</p>
        ...
        <SectionCopy>
          ...
          <p className="ds-subheading-text-style">For fixed spacing, make use of the sass function <code>ds-space($variable)</code> where <code>$variable</code> is either extra-tight (4px), tight (8px), base (16px), bit-loose (24px), loose (32px), extra-loose (48px), or super-loose (64px). In most cases, you will use Fluid Space to layout content and elements on the screen, and Fixed Spacing when composing these elements.</p>
        </SectionCopy>
