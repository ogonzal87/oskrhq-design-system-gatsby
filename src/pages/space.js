      ...
      <div className="ds-container">
        ...
        <div className="ds-col-container">
          ...
          <div className="ds-col-6">
            ...
            <p className="ds-color-page-body  " >The system has a predictable scale to measure fixed space - 4px (extra-tight), 8px (tight), 16px (base), 24px (bit-loose), 32px (loose), 48px (extra-loose), 64px (super-loose).</p>
          </div>
