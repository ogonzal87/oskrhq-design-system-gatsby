      ...
      <div className="ds-left-nav">
        ...
        <ul>
          ...
          <li onClick={this.toggleSublist}><a className="ds-left-nav-component-anchor">Components</a>
            <ul className={`ds-leftnav-subnav-list ${this.state.sublistIsShowing || (window.location !== 'undefined' && window.location.href.includes("components")) ? 'ds-leftnav-subnav-list-is-showing' : ''}`}>
